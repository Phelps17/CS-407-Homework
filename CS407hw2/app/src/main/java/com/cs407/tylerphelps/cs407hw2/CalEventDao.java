...
/** 
 * DAO for table CAL_EVENT.
*/
public class CalEventDao extends AbstractDao<CalEvent, Long> {
    ...
    public CalEventDao(DaoConfig config) {
        super(config);
    }
    
    public CalEventDao(DaoConfig config, DaoSession daoSession) {
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CalEvent entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CalEvent readEntity(Cursor cursor, int offset) {
        CalEvent entity = new CalEvent( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CalEvent entity, int offset) {
    ...
    @Override
    protected Long updateKeyAfterInsert(CalEvent entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(CalEvent entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
